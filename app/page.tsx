...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#101010]">
      ...
      <main className="  px-4 md:px-1  lg:px-8  max-w-7xl mx-auto ">
        <div className="flex flex-col gap-3 pt-4 lg:pt-3 items-center m-0 w-screen/9 md:w-full lg:!max-w-[1350px] lg:mx-auto lg:h-auto lg:mb-4 lg:min-h-auto">
